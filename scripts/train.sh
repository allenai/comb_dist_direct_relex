...
export negative_exampels_percentage=2 # 100  # Values < 100 will randomely drop some of the negative examples
export max_bag_size=2 # 25  # keep only the top `max_bag_size` sentences in each bag and drop the rest
...
export attention_aggregation_fn=max  # avg, max, max_add
